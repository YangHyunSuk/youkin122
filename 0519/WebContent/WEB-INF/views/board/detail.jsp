	...
	<script>
		...
		$(function() {
			...
			$("#list")
					.click(
							function() {
								location.href = "/dbtjd122/board/list?page=${criteria.page}&perPageNum=${criteria.perPageNum}&searchType=${criteria.searchType}&keyword=${criteria.keyword}";
							});
			//버튼눌렀을시삭제
			$("#delete").click(function() {
				location.href ="/dbtjd122/board/delete/"+${vo.bno};});
			//수정버튼눌럿을시
			$("#update").click(function() {
				location.href = "/dbtjd122/board/update/"+${vo.bno};});
		});
	</script>
