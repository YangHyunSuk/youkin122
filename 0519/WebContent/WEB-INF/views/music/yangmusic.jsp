...
<script src="/dbtjd122/resources/js/jquery.min.js"></script>
<script src="/dbtjd122/resources/js/jquery.mobile-1.4.5.min.js"></script>
</head>
<body>
<div data-role='page'>
...
<img width=100 height=100 src="/dbtjd122/resources/image/${yangsong.image}">
<h3>${yangsong.song}</h3>
<p>${yangsong.singer}</p>
