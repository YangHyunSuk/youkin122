...
<div class="box-header with-boder"   style='zlndex: 100; left:0px:top:50px;'>
<span>목록개수</span>
...
//board/list 요청을 보내고 이ㅏ때 page =1 페이지 페이지당 데이터 출력개수는 선택한항목 값으로 
	location.href="/dbtjd122/board/list?page=1&perPageNum="
...
<li>
<a href="/dbtjd122/board/list?page=${pageMaker.startPage-1}&perPageNum=${pageMaker.criteria.perPageNum}&searchType=${criteria.searchType}&keyword=${criteria.keyword}">이전</a>
</li>
</c:if>

<c:forEach var="idx"  begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
<li <c:out value="${pageMaker.criteria.page==idx?'class=active':''}"/>>
<a href="/dbtjd122/board/list?page=${idx}&perPageNum=${pageMaker.criteria.perPageNum}&searchType=${criteria.searchType}&keyword=${criteria.keyword}">${idx}</a>
</li>
</c:forEach>
...
<li>
<a href="dbtjd122/board/list?page=${pageMaker.endPage+1}&perPageNum=${pageMaker.criteria.perPageNum}&searchType=${criteria.searchType}&keyword=${criteria.keyword}">다음</a>
</li>
</c:if>
</ul>
</div>
