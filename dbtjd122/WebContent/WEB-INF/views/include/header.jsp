...
<li><a href="/dbtjd122/mongo/insert"><i class="fa fa-circle-o text-yellow"></i> <span>MongoDB(inset)</span></a></li>
<li><a href="/dbtjd122/mongo/list"><i class="fa fa-circle-o text-yellow"></i> <span>MongoDB(list)</span></a></li>
